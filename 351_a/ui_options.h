...
public:
    ...
    void setupUi(QDialog *Options)
    {
        ...
        chkInvA = new QCheckBox(horizontalLayoutWidget);
        chkInvA->setObjectName(QString::fromUtf8("chkInvA"));

        horizontalLayout->addWidget(chkInvA);
    ...
    void retranslateUi(QDialog *Options)
    {
        ...
        chkInvA->setText(QApplication::translate("Options", "A Axis", 0, QApplication::UnicodeUTF8));
