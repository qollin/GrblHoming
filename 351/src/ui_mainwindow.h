...
public:
    ...
    QLabel *lblZ;
    QLabel *lblC;
    QLCDNumber *lcdWorkNumberC;
    QLCDNumber *lcdMachNumberC;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        lblC = new QLabel(centralWidget);
        lblC->setObjectName(QString::fromUtf8("lblC"));
        sizePolicy5.setHeightForWidth(lblC->sizePolicy().hasHeightForWidth());
        lblC->setSizePolicy(sizePolicy5);
        lblC->setMinimumSize(QSize(29, 0));
        lblC->setMaximumSize(QSize(16777215, 52));
        lblC->setFont(font);
        lblC->setAlignment(Qt::AlignCenter);

        gridLayout_4->addWidget(lblC, 4, 0, 1, 1);

        lcdWorkNumberC = new QLCDNumber(centralWidget);
        lcdWorkNumberC->setObjectName(QString::fromUtf8("lcdWorkNumberC"));
        lcdWorkNumberC->setMaximumSize(QSize(16777215, 52));
        QPalette palette6;
        ...
        lcdWorkNumberC->setPalette(palette6);
        lcdWorkNumberC->setFont(font1);
        lcdWorkNumberC->setFrameShadow(QFrame::Raised);
        lcdWorkNumberC->setSmallDecimalPoint(true);
        lcdWorkNumberC->setDigitCount(7);
        lcdWorkNumberC->setSegmentStyle(QLCDNumber::Filled);

        gridLayout_4->addWidget(lcdWorkNumberC, 4, 2, 1, 1);

        lcdMachNumberC = new QLCDNumber(centralWidget);
        lcdMachNumberC->setObjectName(QString::fromUtf8("lcdMachNumberC"));
        QSizePolicy sizePolicy7(QSizePolicy::Minimum, QSizePolicy::Minimum);
        sizePolicy7.setHorizontalStretch(0);
        sizePolicy7.setVerticalStretch(0);
        sizePolicy7.setHeightForWidth(lcdMachNumberC->sizePolicy().hasHeightForWidth());
        lcdMachNumberC->setSizePolicy(sizePolicy7);
        lcdMachNumberC->setMinimumSize(QSize(0, 40));
        lcdMachNumberC->setMaximumSize(QSize(16777215, 52));
        QPalette palette7;
        ...
        lcdMachNumberC->setPalette(palette7);
        lcdMachNumberC->setFont(font1);
        lcdMachNumberC->setFrameShadow(QFrame::Raised);
        lcdMachNumberC->setLineWidth(1);
        lcdMachNumberC->setMidLineWidth(0);
        lcdMachNumberC->setSmallDecimalPoint(true);
        lcdMachNumberC->setDigitCount(7);
        lcdMachNumberC->setSegmentStyle(QLCDNumber::Filled);

        gridLayout_4->addWidget(lcdMachNumberC, 4, 1, 1, 1);
        ...
        lblCJog = new QLabel(tabAxis);
        lblCJog->setObjectName(QString::fromUtf8("lblCJog"));
        QFont font3;
        font3.setPointSize(10);
        font3.setBold(true);
        font3.setWeight(75);
        lblCJog->setFont(font3);
        lblCJog->setAlignment(Qt::AlignCenter);

        horizontalLayout_5->addWidget(lblCJog);


        gridLayout->addLayout(horizontalLayout_5, 5, 1, 1, 1);

        DecCBtn = new QPushButton(tabAxis);
        DecCBtn->setObjectName(QString::fromUtf8("DecCBtn"));
        DecCBtn->setIcon(icon);
        DecCBtn->setIconSize(QSize(24, 24));

        gridLayout->addWidget(DecCBtn, 5, 0, 1, 1);

        IncCBtn = new QPushButton(tabAxis);
        IncCBtn->setObjectName(QString::fromUtf8("IncCBtn"));
        IncCBtn->setIcon(icon3);
        IncCBtn->setIconSize(QSize(24, 24));

        gridLayout->addWidget(IncCBtn, 5, 2, 1, 1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        lblCJog->setText(QApplication::translate("MainWindow", "C Jog", 0, QApplication::UnicodeUTF8));
        DecCBtn->setText(QString());
        IncCBtn->setText(QString());
