...
public:
    ...
    QLabel *lblZ;
    QLabel *lblA;
    QLCDNumber *lcdWorkNumberA;
    QLCDNumber *lcdMachNumberA;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        comboCommand->setMouseTracking(true);
        ...
        statusList->setEditTriggers(QAbstractItemView::DoubleClicked|QAbstractItemView::EditKeyPressed);
        statusList->setSelectionMode(QAbstractItemView::ExtendedSelection);
        statusList->setSelectionBehavior(QAbstractItemView::SelectItems);
        ...
        statusList->setViewMode(QListView::ListMode);
        ...
        gridLayout_4->addWidget(lblX, 1, 0, 1, 1);
        ...
        gridLayout_4->addWidget(lcdMachNumberY, 2, 1, 1, 1);
        ...
        gridLayout_4->addWidget(lcdWorkNumberY, 2, 2, 1, 1);
        ...
        gridLayout_4->addWidget(lblY, 2, 0, 1, 1);
        ...
        gridLayout_4->addWidget(lcdMachNumberX, 1, 1, 1, 1);
        ...
        gridLayout_4->addWidget(lcdWorkNumberZ, 3, 2, 1, 1);
        ...
        gridLayout_4->addWidget(lcdMachNumberZ, 3, 1, 1, 1);
        ...
        gridLayout_4->addWidget(lcdWorkNumberX, 1, 2, 1, 1);
        ...
        gridLayout_4->addWidget(lblZ, 3, 0, 1, 1);

        lblA = new QLabel(centralWidget);
        lblA->setObjectName(QString::fromUtf8("lblA"));
        sizePolicy5.setHeightForWidth(lblA->sizePolicy().hasHeightForWidth());
        lblA->setSizePolicy(sizePolicy5);
        lblA->setMinimumSize(QSize(29, 0));
        lblA->setMaximumSize(QSize(16777215, 52));
        lblA->setFont(font);
        lblA->setAlignment(Qt::AlignCenter);

        gridLayout_4->addWidget(lblA, 4, 0, 1, 1);

        lcdWorkNumberA = new QLCDNumber(centralWidget);
        lcdWorkNumberA->setObjectName(QString::fromUtf8("lcdWorkNumberA"));
        lcdWorkNumberA->setMaximumSize(QSize(16777215, 52));
        QPalette palette6;
        ...
        lcdWorkNumberA->setPalette(palette6);
        lcdWorkNumberA->setFont(font1);
        lcdWorkNumberA->setFrameShadow(QFrame::Raised);
        lcdWorkNumberA->setSmallDecimalPoint(true);
        lcdWorkNumberA->setDigitCount(7);
        lcdWorkNumberA->setSegmentStyle(QLCDNumber::Filled);

        gridLayout_4->addWidget(lcdWorkNumberA, 4, 2, 1, 1);

        lcdMachNumberA = new QLCDNumber(centralWidget);
        lcdMachNumberA->setObjectName(QString::fromUtf8("lcdMachNumberA"));
        QSizePolicy sizePolicy7(QSizePolicy::Minimum, QSizePolicy::Minimum);
        sizePolicy7.setHorizontalStretch(0);
        sizePolicy7.setVerticalStretch(0);
        sizePolicy7.setHeightForWidth(lcdMachNumberA->sizePolicy().hasHeightForWidth());
        lcdMachNumberA->setSizePolicy(sizePolicy7);
        lcdMachNumberA->setMinimumSize(QSize(0, 40));
        lcdMachNumberA->setMaximumSize(QSize(16777215, 52));
        QPalette palette7;
        ...
        lcdMachNumberA->setPalette(palette7);
        lcdMachNumberA->setFont(font1);
        lcdMachNumberA->setFrameShadow(QFrame::Raised);
        lcdMachNumberA->setLineWidth(1);
        lcdMachNumberA->setMidLineWidth(0);
        lcdMachNumberA->setSmallDecimalPoint(true);
        lcdMachNumberA->setDigitCount(7);
        lcdMachNumberA->setSegmentStyle(QLCDNumber::Filled);

        gridLayout_4->addWidget(lcdMachNumberA, 4, 1, 1, 1);
        ...
        verticalLayout_RightControls->addLayout(gridLayout_4);
        ...
        lblAJog = new QLabel(tabAxis);
        lblAJog->setObjectName(QString::fromUtf8("lblAJog"));
        QFont font3;
        font3.setPointSize(10);
        font3.setBold(true);
        font3.setWeight(75);
        lblAJog->setFont(font3);
        lblAJog->setAlignment(Qt::AlignCenter);

        horizontalLayout_5->addWidget(lblAJog);


        gridLayout->addLayout(horizontalLayout_5, 5, 1, 1, 1);

        DecABtn = new QPushButton(tabAxis);
        DecABtn->setObjectName(QString::fromUtf8("DecABtn"));
        DecABtn->setIcon(icon);
        DecABtn->setIconSize(QSize(24, 24));

        gridLayout->addWidget(DecABtn, 5, 0, 1, 1);

        IncABtn = new QPushButton(tabAxis);
        IncABtn->setObjectName(QString::fromUtf8("IncABtn"));
        IncABtn->setIcon(icon3);
        IncABtn->setIconSize(QSize(24, 24));

        gridLayout->addWidget(IncABtn, 5, 2, 1, 1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        lblAJog->setText(QApplication::translate("MainWindow", "A Jog", 0, QApplication::UnicodeUTF8));
        DecABtn->setText(QString());
        IncABtn->setText(QString());
